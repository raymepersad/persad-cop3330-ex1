    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "oop.example");
                servletContext.setInitParameter("tapestry.development-modules", "oop.example.services.DevelopmentModule");
